...
## addition to bring in lxml.etree as a submodule of inkex
## previous version of inkex imported etree into base namespace
from inkex.base import etree
inkex.etree = etree
